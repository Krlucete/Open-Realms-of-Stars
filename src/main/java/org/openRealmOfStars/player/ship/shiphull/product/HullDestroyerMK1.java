...
*
*
* HullDestroyerMk1 (Concrete Product)
*
*/
public class HullDestroyerMK1 extends ShipHull {
    /**
     ...
     */
    public HullDestroyerMK1(final SpaceRace race) {
        super(HULL_DESTROYER_MK1, "Destroyer Mk1", 6, 1, ShipHullType.NORMAL,
