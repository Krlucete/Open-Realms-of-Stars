...
*
*
* ScoutMK1HullCreator (Concrete Creator)
*
*/
public class ScoutMK1HullCreator extends ShipHullCreator {

    /**
     * Constructor for ScoutMK1HullCreator
     */
    public ScoutMK1HullCreator() {
