...
*
*
* HullCorvetteMK2 (Concrete Product)
*
*/
public class HullCorvetteMK2 extends ShipHull {
    /**
     ...
     */
    public HullCorvetteMK2(final SpaceRace race) {
        super(HULL_CORVETTE_MK2, "Corvette Mk2", 5, 2, ShipHullType.NORMAL,
