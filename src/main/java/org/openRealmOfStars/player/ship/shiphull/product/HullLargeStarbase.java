...
*
*
* HullLargeStarbase (Concrete Product)
*
*/
public class HullLargeStarbase extends ShipHull {
    /**
     ...
     */
    public HullLargeStarbase(final SpaceRace race) {
        super(HULL_LARGE_STARBASE, "Large starbase", 8, 3,
                ShipHullType.STARBASE,
                ShipSize.LARGE, 15, 15, race);
            super.setImageIndex(ShipImage.LARGE_STARBASE);
    }
}
