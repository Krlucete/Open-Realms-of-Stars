...
import org.openRealmOfStars.player.ship.shiphull.product.HullDestroyerMK4;
...
*
*
* DestroyerMK4HullCreator (Concrete Creator)
*
*/
public class DestroyerMK4HullCreator extends ShipHullCreator {

    /**
     * Constructor for DestroyerMK4HullCreator
     */
    public DestroyerMK4HullCreator() {
        // TODO Auto-generated constructor stub
    }

    /**
     * @param race whom builds the ship hull
     * @return HullDestroyerMK4
     */
    @Override
    public ShipHull create(final SpaceRace race) {
        return new HullDestroyerMK4(race);
    }
