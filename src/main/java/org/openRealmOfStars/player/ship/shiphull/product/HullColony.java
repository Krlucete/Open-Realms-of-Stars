...
*
*
* HullColony (Concrete Product)
*
*/
public class HullColony extends ShipHull {
    /**
     * Hull for Colony
     */
     ...
     */
    public HullColony(final SpaceRace race) {
        super(HULL_COLONY, "Colony", 4, 1, ShipHullType.FREIGHTER,
                ShipSize.MEDIUM, 4, 6, race);
        super.setImageIndex(ShipImage.COLONY);
