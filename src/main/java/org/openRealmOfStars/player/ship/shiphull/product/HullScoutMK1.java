...
*
*
* HullScoutMk1 (Concrete Product)
*
*/
public class HullScoutMK1 extends ShipHull {
    /**
     * Hull for Scout Mk1
     */
     ...
     */
    public HullScoutMK1(final SpaceRace race) {
        super(HULL_SCOUT_MK1, "Scout Mk1", 4, 1, ShipHullType.NORMAL,
