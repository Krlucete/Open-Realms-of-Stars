...
*
*
* HullProve (Concrete Product)
*
*/
public class HullProbe extends ShipHull {
    /**
     * Hull for Probe
     */
     ...
     */
    public HullProbe(final SpaceRace race) {
        super(HULL_PROBE, "Probe", 4, 1, ShipHullType.PROBE,
                ShipSize.SMALL, 2, 2, race);
        super.setImageIndex(ShipImage.PROBE);
