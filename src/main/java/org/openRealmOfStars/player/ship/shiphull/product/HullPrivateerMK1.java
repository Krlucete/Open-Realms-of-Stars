...
*
*
* HullPrivateerMK1 (Concrete Product)
*
*/
public class HullPrivateerMK1 extends ShipHull {
    /**
     ...
     */
    public HullPrivateerMK1(final SpaceRace race) {
        super(HULL_PRIVATEER_MK1, "Privateer Mk1", 6, 2, ShipHullType.PRIVATEER,
                ShipSize.MEDIUM, 8, 8, race);
        super.setImageIndex(ShipImage.PRIVATEER);
    }
}
