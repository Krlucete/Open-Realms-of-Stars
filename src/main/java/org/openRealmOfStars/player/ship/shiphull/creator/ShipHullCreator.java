...
*
*
* ShipHullCreator (Abstract Creator)
*
*/
public abstract class ShipHullCreator {
    /**
     * Constructor for Ship hull Creator
     */
    public ShipHullCreator() {
     ...
     * @return ShipHull
     */
    public abstract ShipHull create(SpaceRace race);
}
