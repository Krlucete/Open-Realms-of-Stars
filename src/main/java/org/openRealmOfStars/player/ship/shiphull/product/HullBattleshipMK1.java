...
*
*
* HullBattleshipMk1 (Concrete Product)
*
*/
public class HullBattleshipMK1 extends ShipHull {
    /**
     ...
     */
    public HullBattleshipMK1(final SpaceRace race) {
        super(HULL_BATTLESHIP_MK1, "Battleship Mk1", 10, 2, ShipHullType.NORMAL,
