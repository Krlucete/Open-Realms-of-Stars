...
*
*
* HullBattleCruiserMK2 (Concrete Product)
*
*/
public class HullBattleCruiserMK2 extends ShipHull {
    /**
     ...
     */
    public HullBattleCruiserMK2(final SpaceRace race) {
        super(HULL_BATTLE_CRUISER_MK2,
                "Battle cruiser Mk2",
                9, 3,
                ShipHullType.NORMAL,
                ShipSize.LARGE,
                18, 18,
                race);
            super.setImageIndex(ShipImage.BATTLECRUISER);
    }
}
