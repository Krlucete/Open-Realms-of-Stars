...
*
*
* HullSmallStarbaseMK1 (Concrete Product)
*
*/
public class HullSmallStarbaseMK1 extends ShipHull {
    /**
     ...
     */
    public HullSmallStarbaseMK1(final SpaceRace race) {
        super(HULL_SMALL_STARBASE_MK1, "Small starbase Mk1", 4, 1,
