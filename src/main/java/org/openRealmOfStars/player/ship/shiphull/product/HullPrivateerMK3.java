...
*
*
* HullPrivateerMK3 (Concrete Product)
*
*/
public class HullPrivateerMK3 extends ShipHull {
    /**
     ...
     */
    public HullPrivateerMK3(final SpaceRace race) {
        super(HULL_PRIVATEER_MK3, "Privateer Mk3", 8, 3, ShipHullType.PRIVATEER,
