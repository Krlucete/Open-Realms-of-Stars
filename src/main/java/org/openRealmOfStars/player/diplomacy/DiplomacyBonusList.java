...
public class DiplomacyBonusList {
    ...
    /**
     * Constructor for Diplomacy Bonus List. List contains diplomacy bonuses for
     * certain player by some player. DiplomacyBonusList class does not define
     * that player who creates the list only the player who list affects.
     * 
     * @param index
     *            Index for player info
     */
    ...
    /**
     * Make war so that Alliance, trade alliance and long peace are removed from
     * the list
     */
    ...
    /**
     * Checks if diplomacy bonus list contains certain bonus type. Returns true
     * if bonus type is found
     * 
     * @param type
     *            DiplomacyBonusType to find
    ...
    /**
     * Add Diplomacy bonus to list. If diplomacy is type which can be only one
     * and there is already one in list, then nothing is done.
     * 
     * @param type
     *            DiplomacyBonusType to add
     * @param race
     *            Race who is adding the bonus
    ...
    /**
     * Handle diplomacy bonus list for one turn. This will calculate bonus
     * lasting and remove bonuses which lasting is zero.
     */
